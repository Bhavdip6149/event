  ...
  <section id="services" class="services">
    ...
    <div class="service-grid">
      ...
      <div class="service-card">
        <img src="images/cateringw.jpg" alt="Designer Cakes">
        <h3>Catering</h3>
        <p>From our catering to royal wedding masterpieces, every creation is baked with love, flavor, and art.</p>
