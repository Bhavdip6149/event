...
// NOTE: This file is included inside admin_dashboard.php
...
if (isset($_GET['action']) && $_GET['action'] == 'delete_user' && isset($_GET['id'])) {
    ...
    // Instead of PHP redirect (header), use JS redirect (no warning)
    echo "<script>
            alert('{$status_message}');
            window.location.href = 'admin_dashboard.php?page=users';
          </script>";
    exit();
}
...
function confirmDelete(id) {
    if (confirm("Are you sure you want to delete this user? This action cannot be undone.")) {
        window.location.href = `admin_dashboard.php?page=users&action=delete_user&id=${id}`;
    }
}
</script>
